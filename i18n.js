...
const I18N = {
  ...
  strings: {
    de: {
      ...
      "sec.holdingsHint": 'Pro Zeile WKN oder ISIN und Betrag in €. „＋" übernimmt und öffnet darunter eine neue Zeile — ist die WKN schon vorhanden, wird der Betrag in die bestehende Zeile addiert. Der Mülleimer entfernt den Eintrag, Werte bleiben jederzeit editierbar.',
      "sec.buy": 'Monatlicher Sparplan',
      "sec.buyHint": 'Pro Zeile WKN oder ISIN und monatlicher Betrag in €. „＋" übernimmt und öffnet eine neue Zeile — bei doppelter WKN wird der Betrag in die bestehende Zeile addiert; der Mülleimer entfernt sie.',
      "sec.proj": 'Depot-Entwicklung',
      "sec.projHint": 'Basis: dein Bestand (Sektion 1) + die monatlichen Käufe aus dem Monatlichen Sparplan (Sektion 2), verzinst mit monatlichem Zinseszins. Die Renditen sind langfristige Annahmen — anpassbar, keine Garantie.',
    ...
    en: {
      ...
      "sec.holdingsHint": 'Enter a WKN or ISIN and an amount in EUR per row. "+" confirms the row and opens a new one below — if the WKN already exists, the amount is added to the existing row. The trash icon removes the entry; values remain editable at any time.',
      "sec.buy": 'Monthly Savings Plan',
      "sec.buyHint": 'Enter a WKN or ISIN and a monthly amount in EUR per row. "+" confirms the row and opens a new one — for a duplicate WKN the amount is added to the existing row; the trash icon removes it.',
      "sec.proj": 'Portfolio Growth',
      "sec.projHint": 'Basis: your portfolio (Section 1) + the monthly purchases from the Monthly Savings Plan (Section 2), compounded monthly. The returns are long-term assumptions — adjustable, no guarantee.',
