...
const I18N = {
  ...
  strings: {
    de: {
      ...
      "rate.modeAria": 'Rendite-Modus: eine Rendite für alle ETFs oder je ETF einzeln',
      "rate.modeSingle": 'Alle',
      "rate.modePerEtf": 'Einzeln',
      "rate.singleName": 'Alle ETFs',
    ...
    en: {
      ...
      "rate.modeAria": 'Return mode: one rate for all ETFs or individual per ETF',
      "rate.modeSingle": 'All',
      "rate.modePerEtf": 'Individual',
      "rate.singleName": 'All ETFs',
