...
const I18N = {
  ...
  strings: {
    de: {
      ...
      "sec.holdingsHint": 'Trage hier ein, was du bereits besitzt — pro ETF eine Zeile mit WKN oder ISIN und Betrag.',
      "sec.buy": 'Monatlicher Sparplan',
      "sec.buyHint": 'Trage hier ein, was du monatlich kaufen willst — pro ETF eine Zeile mit WKN oder ISIN und Betrag.',
    ...
    en: {
      ...
      "sec.holdingsHint": 'Enter what you already own — one row per ETF with WKN or ISIN and amount.',
      "sec.buy": 'Monthly Savings Plan',
      "sec.buyHint": 'Enter what you want to buy each month — one row per ETF with WKN or ISIN and amount.',
